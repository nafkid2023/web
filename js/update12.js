...
function sendPostMessage(_0x4eb976, _0x4a7105) {
		console.log('Sedang Mengirim pesan', 'https://vero-sports.blogspot.com');
  var _0x126c9e = document.getElementById(_0x4eb976).contentWindow;
  //_0x126c9e.postMessage(btoa(_0x4a7105), "https://duktek-player.blogspot.com");
  _0x126c9e.postMessage(btoa(_0x4a7105), "https://vero-sports.blogspot.com");
}
    ...
    _playerInstance.setup({
      ...
      if (navigator.onLine) {
		...
		if(!_isReady || $('#shaka_player_iframe').length == 0){
			...
			$("#embed_shaka").show();
			console.log('tidak megirim data');
		} else {
			//sendPostMessage('shaka_player_iframe', _shakaPlayerUrl); 
			const iframe = document.getElementById("shaka_player_iframe");
			iframe.contentWindow.postMessage(btoa(_shakaPlayerUrl), "https://veros-player.blogspot.com");
		...
		var _keyMulti			= _0x367781.url_license.split(',');
		var _keyString			= [];
