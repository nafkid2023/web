...
var _reloadMenu = function () {
  ...
  $.get('https://raw.githubusercontent.com/nafkid2023/web/main/json/livetv.json', {}, function (_jsonDataLiveTVEncrypted) {
	  
	(async () => {
		const secret = "indonesia";
		const encryptedBase64 = _jsonDataLiveTVEncrypted;

		try {
			const _jsonDataLiveTV = await decryptAESGCM(encryptedBase64, secret);
			console.log("Decrypted:", _jsonDataLiveTV);
			var _0x1245c6 = '';
