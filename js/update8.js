...
function sendPostMessage(targetFrame, player_url){
	const iframe = document.getElementById(targetFrame);
	const targetIframeOrigin = 'https://veros-player.blogspot.com';
	var dataKeIframe = btoa(player_url);
	//iframe.contentWindow.postMessage(btoa(player_url), targetOrigin);	
	iframe.contentWindow.postMessage(dataKeIframe, targetIframeOrigin);
	console.log('Pesan dikirim dari Utama ke Player.');
}
